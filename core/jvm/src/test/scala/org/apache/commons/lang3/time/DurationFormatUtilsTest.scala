...
//  */
//object DurationFormatUtilsTest {
...
//  }
//
//  @Test def testFormatDurationWords() = {
//    var text = null
...
//    */
//  @Test def testFormatDurationPluralWords() = {
//    val oneSecond = 1000
...
//  }
//
//  @Test def testFormatNegativeDurationWords() = assertThrows(classOf[IllegalArgumentException], () => DurationFormatUtils.formatDurationWords(-5000, true, true))
//
//  @Test def testFormatDurationHMS() = {
//    var time = 0
...
//  }
//
//  @Test def testFormatNegativeDurationHMS() = assertThrows(classOf[IllegalArgumentException], () => DurationFormatUtils.formatDurationHMS(-5000))
//
//  @Test def testFormatDurationISO() = {
...
//  }
//
//  @Test def testFormatNegativeDurationISO() = assertThrows(classOf[IllegalArgumentException], () => DurationFormatUtils.formatDurationISO(-5000))
//
...
//    val days = 366 + 365 + 365 + 31
//    assertEquals("0 0 " + days, DurationFormatUtils.formatDuration(duration, "y M d"))
//  }
//
//  @Test def testFormatNegativeDuration() = assertThrows(classOf[IllegalArgumentException], () => DurationFormatUtils.formatDuration(-5000, "S", true))
//
//  @SuppressWarnings(Array("deprecation"))
//  @Test def testFormatPeriodISO() = {
//    val timeZone = TimeZone.getTimeZone("GMT-3")
//    val base = Calendar.getInstance(timeZone)
...
//  }
//
//  @Test def testFormatPeriodISOStartGreaterEnd() = assertThrows(classOf[IllegalArgumentException], () => DurationFormatUtils.formatPeriodISO(5000, 2000))
//
//  @Test def testFormatPeriodISOMethod() = {
...
//  }
//
//  @Test def testFormatPeriodeStartGreaterEnd() = assertThrows(classOf[IllegalArgumentException], () => DurationFormatUtils.formatPeriod(5000, 2500, "yy/MM"))
//
//  @Test def testLexx() = { // tests each constant
//    assertArrayEquals(Array[Nothing](new Nothing(DurationFormatUtils.y, 1), new Nothing(DurationFormatUtils.M, 1), new Nothing(DurationFormatUtils.d, 1), new Nothing(DurationFormatUtils.H, 1), new Nothing(DurationFormatUtils.m, 1), new Nothing(DurationFormatUtils.s, 1), new Nothing(DurationFormatUtils.S, 1)), DurationFormatUtils.lexx("yMdHmsS"))
//    // tests the ISO 8601-like
//    assertArrayEquals(Array[Nothing](new Nothing(DurationFormatUtils.H, 2), new Nothing(new StringBuilder(":"), 1), new Nothing(DurationFormatUtils.m, 2), new Nothing(new StringBuilder(":"), 1), new Nothing(DurationFormatUtils.s, 2), new Nothing(new StringBuilder("."), 1), new Nothing(DurationFormatUtils.S, 3)), DurationFormatUtils.lexx("HH:mm:ss.SSS"))
//    // test the iso extended format
//    assertArrayEquals(Array[Nothing](new Nothing(new StringBuilder("P"), 1), new Nothing(DurationFormatUtils.y, 4), new Nothing(new StringBuilder("Y"), 1), new Nothing(DurationFormatUtils.M, 1), new Nothing(new StringBuilder("M"), 1), new Nothing(DurationFormatUtils.d, 1), new Nothing(new StringBuilder("DT"), 1), new Nothing(DurationFormatUtils.H, 1), new Nothing(new StringBuilder("H"), 1), new Nothing(DurationFormatUtils.m, 1), new Nothing(new StringBuilder("M"), 1), new Nothing(DurationFormatUtils.s, 1), new Nothing(new StringBuilder("."), 1), new Nothing(DurationFormatUtils.S, 3), new Nothing(new StringBuilder("S"), 1)), DurationFormatUtils.lexx(DurationFormatUtils.ISO_EXTENDED_FORMAT_PATTERN))
//    // test failures in equals
//    val token = new Nothing(DurationFormatUtils.y, 4)
//    assertNotEquals(token, new Any, "Token equal to non-Token class. ")
//    assertNotEquals(token, new Nothing(new Any), "Token equal to Token with wrong value class. ")
//    assertNotEquals(token, new Nothing(DurationFormatUtils.y, 1), "Token equal to Token with different count. ")
//    val numToken = new Nothing(Integer.valueOf(1), 4)
...
//  @Test def testBugzilla38401() = assertEqualDuration("0000/00/30 16:00:00 000", Array[Int](2006, 0, 26, 18, 47, 34), Array[Int](2006, 1, 26, 10, 47, 34), "yyyy/MM/dd HH:mm:ss SSS")
//
//  // https://issues.apache.org/jira/browse/LANG-281
//  @Test def testJiraLang281() = assertEqualDuration("09", Array[Int](2005, 11, 31, 0, 0, 0), Array[Int](2006, 9, 6, 0, 0, 0), "MM")
//
//  @Test def testLANG815() = {
//    val calendar = Calendar.getInstance
//    calendar.set(2012, Calendar.JULY, 30, 0, 0, 0)
//    val startMillis = calendar.getTimeInMillis
//    calendar.set(2012, Calendar.SEPTEMBER, 8)
//    val endMillis = calendar.getTimeInMillis
...
//  @Test def testLowDurations() = for (hr <- 0 until 24) {
//    for (min <- 0 until 60) {
//      for (sec <- 0 until 60) {
//        assertEqualDuration(hr + ":" + min + ":" + sec, Array[Int](2000, 0, 1, 0, 0, 0, 0), Array[Int](2000, 0, 1, hr, min, sec), "H:m:s")
//      }
//    }
//  }
//
//  // Attempting to test edge cases in DurationFormatUtils.formatPeriod
//  @Test def testEdgeDurations() = { // This test case must use a time zone without DST
//    TimeZone.setDefault(FastTimeZone.getGmtTimeZone)
//    assertEqualDuration("01", Array[Int](2006, 0, 15, 0, 0, 0), Array[Int](2006, 2, 10, 0, 0, 0), "MM")
//    assertEqualDuration("12", Array[Int](2005, 0, 15, 0, 0, 0), Array[Int](2006, 0, 15, 0, 0, 0), "MM")
//    assertEqualDuration("12", Array[Int](2005, 0, 15, 0, 0, 0), Array[Int](2006, 0, 16, 0, 0, 0), "MM")
//    assertEqualDuration("11", Array[Int](2005, 0, 15, 0, 0, 0), Array[Int](2006, 0, 14, 0, 0, 0), "MM")
//    assertEqualDuration("01 26", Array[Int](2006, 0, 15, 0, 0, 0), Array[Int](2006, 2, 10, 0, 0, 0), "MM dd")
//    assertEqualDuration("54", Array[Int](2006, 0, 15, 0, 0, 0), Array[Int](2006, 2, 10, 0, 0, 0), "dd")
//    assertEqualDuration("09 12", Array[Int](2006, 1, 20, 0, 0, 0), Array[Int](2006, 11, 4, 0, 0, 0), "MM dd")
//    assertEqualDuration("287", Array[Int](2006, 1, 20, 0, 0, 0), Array[Int](2006, 11, 4, 0, 0, 0), "dd")
//    assertEqualDuration("11 30", Array[Int](2006, 0, 2, 0, 0, 0), Array[Int](2007, 0, 1, 0, 0, 0), "MM dd")
//    assertEqualDuration("364", Array[Int](2006, 0, 2, 0, 0, 0), Array[Int](2007, 0, 1, 0, 0, 0), "dd")
//    assertEqualDuration("12 00", Array[Int](2006, 0, 1, 0, 0, 0), Array[Int](2007, 0, 1, 0, 0, 0), "MM dd")
//    assertEqualDuration("365", Array[Int](2006, 0, 1, 0, 0, 0), Array[Int](2007, 0, 1, 0, 0, 0), "dd")
//    assertEqualDuration("31", Array[Int](2006, 0, 1, 0, 0, 0), Array[Int](2006, 1, 1, 0, 0, 0), "dd")
//    assertEqualDuration("92", Array[Int](2005, 9, 1, 0, 0, 0), Array[Int](2006, 0, 1, 0, 0, 0), "dd")
//    assertEqualDuration("77", Array[Int](2005, 9, 16, 0, 0, 0), Array[Int](2006, 0, 1, 0, 0, 0), "dd")
//    // test month larger in start than end
//    assertEqualDuration("136", Array[Int](2005, 9, 16, 0, 0, 0), Array[Int](2006, 2, 1, 0, 0, 0), "dd")
//    // test when start in leap year
//    assertEqualDuration("136", Array[Int](2004, 9, 16, 0, 0, 0), Array[Int](2005, 2, 1, 0, 0, 0), "dd")
//    // test when end in leap year
//    assertEqualDuration("137", Array[Int](2003, 9, 16, 0, 0, 0), Array[Int](2004, 2, 1, 0, 0, 0), "dd")
//    // test when end in leap year but less than end of feb
//    assertEqualDuration("135", Array[Int](2003, 9, 16, 0, 0, 0), Array[Int](2004, 1, 28, 0, 0, 0), "dd")
//    assertEqualDuration("364", Array[Int](2007, 0, 2, 0, 0, 0), Array[Int](2008, 0, 1, 0, 0, 0), "dd")
//    assertEqualDuration("729", Array[Int](2006, 0, 2, 0, 0, 0), Array[Int](2008, 0, 1, 0, 0, 0), "dd")
//    assertEqualDuration("365", Array[Int](2007, 2, 2, 0, 0, 0), Array[Int](2008, 2, 1, 0, 0, 0), "dd")
//    assertEqualDuration("333", Array[Int](2007, 1, 2, 0, 0, 0), Array[Int](2008, 0, 1, 0, 0, 0), "dd")
//    assertEqualDuration("28", Array[Int](2008, 1, 2, 0, 0, 0), Array[Int](2008, 2, 1, 0, 0, 0), "dd")
//    assertEqualDuration("393", Array[Int](2007, 1, 2, 0, 0, 0), Array[Int](2008, 2, 1, 0, 0, 0), "dd")
//    assertEqualDuration("369", Array[Int](2004, 0, 29, 0, 0, 0), Array[Int](2005, 1, 1, 0, 0, 0), "dd")
//    assertEqualDuration("338", Array[Int](2004, 1, 29, 0, 0, 0), Array[Int](2005, 1, 1, 0, 0, 0), "dd")
//    assertEqualDuration("28", Array[Int](2004, 2, 8, 0, 0, 0), Array[Int](2004, 3, 5, 0, 0, 0), "dd")
//    assertEqualDuration("48", Array[Int](1992, 1, 29, 0, 0, 0), Array[Int](1996, 1, 29, 0, 0, 0), "M")
...
//    assertEqualDuration("11", Array[Int](1996, 1, 29, 0, 0, 0), Array[Int](1997, 1, 28, 0, 0, 0), "M")
//    // again - this seems odd
//    assertEqualDuration("11 28", Array[Int](1996, 1, 29, 0, 0, 0), Array[Int](1997, 1, 28, 0, 0, 0), "M d")
//  }
//
//  @Test def testLANG984() = { // Long durations
...
//    var maxIntPlus = Integer.MAX_VALUE
//    maxIntPlus += 1
...
//  }
//
//  @Test def testLANG982() = { // More than 3 millisecond digits following a second
...
//  }
//
//  @Test def testDurationsByBruteForce() = {
...
//  }
//
//  @Test def testLANG981() = { // unmatched quote char in lexx
//    assertThrows(classOf[IllegalArgumentException], () => DurationFormatUtils.lexx("'yMdHms''S"))
//  }
//
//  private def bruteForce(year: Int, month: Int, day: Int, format: String, calendarType: Int) = {
//    val msg = year + "-" + month + "-" + day + " to "
//    val c = Calendar.getInstance
//    c.set(year, month, day, 0, 0, 0)
//    val array1 = Array[Int](year, month, day, 0, 0, 0)
//    val array2 = Array[Int](year, month, day, 0, 0, 0)
//    for (i <- 0 until DurationFormatUtilsTest.FOUR_YEARS) {
//      array2(0) = c.get(Calendar.YEAR)
//      array2(1) = c.get(Calendar.MONTH)
//      array2(2) = c.get(Calendar.DAY_OF_MONTH)
//      val tmpMsg = msg + array2(0) + "-" + array2(1) + "-" + array2(2) + " at "
//      assertEqualDuration(tmpMsg + i, Integer.toString(i), array1, array2, format)
//      c.add(calendarType, 1)
//    }
//  }
//
//  private def assertEqualDuration(expected: String, start: Array[Int], `end`: Array[Int], format: String) = assertEqualDuration(null, expected, start, `end`, format)
//
//  private def assertEqualDuration(message: String, expected: String, start: Array[Int], `end`: Array[Int], format: String) = {
...
//    val milli1 = cal1.getTime.getTime
//    val milli2 = cal2.getTime.getTime
//    val result = DurationFormatUtils.formatPeriod(milli1, milli2, format)
//    if (message == null) assertEquals(expected, result)
//    else assertEquals(expected, result, message)
//  }
//}
