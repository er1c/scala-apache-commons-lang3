...
class NotImplementedExceptionTest extends JUnitSuite {
  @Test def testConstructors() = {
    ...
    var nie: NotImplementedException = new NotImplementedException(message)
  ...
  private def assertCorrect(assertMessage: String, nie: NotImplementedException, message: String, nested: Throwable, code: String) = {
