...
//    */
//  @Test def testCompositeFormat() = {
//    val parser = new Format() {
//      override def format(obj: Any, toAppendTo: StringBuffer, pos: FieldPosition) = throw new UnsupportedOperationException("Not implemented")
//
//      override
//
//      def parseObject(source: String, pos: ParsePosition) = null // do nothing
//    }
...
//      override
//
//      def parseObject(source: String, pos: ParsePosition) = throw new UnsupportedOperationException("Not implemented")
//    }
//    val composite = new Nothing(parser, formatter)
//    composite.parseObject("", null)
//    composite.format(new Any, new StringBuffer, null)
