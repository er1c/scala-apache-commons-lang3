...
class StrBuilderAppendInsertTest extends JUnitSuite {
  ...
  @Test def testAppendWithNullText(): Unit = {
  ...
  @Test def testAppend_Object(): Unit = {
    val sb = new StrBuilder
    sb.appendNull
    assertEquals("", sb.toString)
    sb.append(null.asInstanceOf[Any])
  ...
  @Test def testAppend_StringBuilder(): Unit = {
    var sb = new StrBuilder
  ...
  @Test def testAppend_String(): Unit = {
    var sb = new StrBuilder
    sb.setNullText("NULL").append(null.asInstanceOf[String])
    assertEquals("NULL", sb.toString)
    sb = new StrBuilder
  ...
  @Test def testAppend_String_int_int(): Unit = {
    var sb = new StrBuilder
  ...
  @Test def testAppend_StringBuilder_int_int(): Unit = {
    var sb = new StrBuilder
    sb.setNullText("NULL").append(null.asInstanceOf[String], 0, 1)
    assertEquals("NULL", sb.toString)
    sb = new StrBuilder
  ...
  @Test def testAppend_StringBuffer(): Unit = {
    var sb = new StrBuilder
  ...
  @Test def testAppend_StringBuffer_int_int(): Unit = {
    var sb = new StrBuilder
  ...
  @Test def testAppend_StrBuilder(): Unit = {
    var sb = new StrBuilder
  ...
  @Test def testAppend_StrBuilder_int_int(): Unit = {
    var sb = new StrBuilder
  ...
  @Test def testAppend_CharArray(): Unit = {
    var sb = new StrBuilder
  ...
  @Test def testAppend_CharArray_int_int(): Unit = {
    var sb = new StrBuilder
    ...
    val sb1 = sb
    assertThrows[IndexOutOfBoundsException](
      sb1.append(Array[Char]('b', 'a', 'r'), -1, 1)
    ) //, "append(char[], -1,) expected IndexOutOfBoundsException")
    assertThrows[IndexOutOfBoundsException](
      sb1.append(Array[Char]('b', 'a', 'r'), 3, 1)
    ) //, "append(char[], 3,) expected IndexOutOfBoundsException")
    assertThrows[IndexOutOfBoundsException](
      sb1.append(Array[Char]('b', 'a', 'r'), 1, -1)
    ) //, "append(char[],, -1) expected IndexOutOfBoundsException")
    assertThrows[IndexOutOfBoundsException](
      sb1.append(Array[Char]('b', 'a', 'r'), 1, 3)
    ) //, "append(char[], 1, 3) expected IndexOutOfBoundsException")
    assertThrows[IndexOutOfBoundsException](
      sb1.append(Array[Char]('b', 'a', 'r'), -1, 3)
    ) //, "append(char[], -1, 3) expected IndexOutOfBoundsException")
    assertThrows[IndexOutOfBoundsException](
      sb1.append(Array[Char]('b', 'a', 'r'), 4, 0)
    ) //, "append(char[], 4, 0) expected IndexOutOfBoundsException")
  ...
  @Test def testAppend_Boolean(): Unit = {
    val sb = new StrBuilder
    sb.append(true)
  ...
  @Test def testAppend_PrimitiveNumber(): Unit = {
    val sb = new StrBuilder
    sb.append(0)
  ...
  @Test def testAppendln_FormattedString(): Unit = {
    val count = new Array[Int](2)
    val sb = new StrBuilder() {
      override def append(str: String): StrBuilder = {
        count(0) += 1
        super.append(str)
      }

      override def appendNewLine: StrBuilder = {
        count(1) += 1
        super.appendNewLine
      }
    }
  ...
  @Test def testAppendln_Object(): Unit = {
    val sb = new StrBuilder
    ...
    assertEquals(
      StrBuilderAppendInsertTest.SEP + "foo" + StrBuilderAppendInsertTest.SEP + "6" + StrBuilderAppendInsertTest.SEP,
      sb.toString)
  }

  @Test def testAppendln_String(): Unit = {
    val count = new Array[Int](2)
    val sb = new StrBuilder() {
      override def append(str: String): StrBuilder = {
        count(0) += 1
  ...
  @Test def testAppendln_String_int_int(): Unit = {
    val count = new Array[Int](2)
    val sb = new StrBuilder() {
      override def append(str: String, startIndex: Int, length: Int): StrBuilder = {
        count(0) += 1
  ...
  @Test def testAppendln_StringBuffer(): Unit = {
    val count = new Array[Int](2)
    val sb = new StrBuilder() {
      override def append(str: StringBuffer): StrBuilder = {
        count(0) += 1
        super.append(str)
      }
  ...
  @Test def testAppendln_StringBuilder(): Unit = {
    val count = new Array[Int](2)

    val sb = new StrBuilder() {
      override def append(str: java.lang.StringBuilder): StrBuilder = {
        count(0) += 1
        super.append(str)
      }
    ...
    sb.appendln(new java.lang.StringBuilder("foo"))
    assertEquals("foo" + StrBuilderAppendInsertTest.SEP, sb.toString)
    assertEquals(1, count(0))
    assertEquals(1, count(1))
  }

  @Test def testAppendln_StringBuffer_int_int(): Unit = {
    val count = new Array[Int](2)
    val sb = new StrBuilder() {
      override def append(str: StringBuffer, startIndex: Int, length: Int): StrBuilder = {
        count(0) += 1
        super.append(str, startIndex, length)
      }
  ...
  @Test def testAppendln_StringBuilder_int_int(): Unit = {
    val count = new Array[Int](2)
    val sb = new StrBuilder() {
      override def append(str: java.lang.StringBuilder, startIndex: Int, length: Int): StrBuilder = {
        count(0) += 1
        super.append(str, startIndex, length)
      }
    ...
    sb.appendln(new java.lang.StringBuilder("foo"), 0, 3)
    assertEquals("foo" + StrBuilderAppendInsertTest.SEP, sb.toString)
    assertEquals(1, count(0))
    assertEquals(1, count(1))
  }

  @Test def testAppendln_StrBuilder(): Unit = {
    val count = new Array[Int](2)
    val sb = new StrBuilder() {
      override def append(str: StrBuilder): StrBuilder = {
        count(0) += 1
        super.append(str)
      }
  ...
  @Test def testAppendln_StrBuilder_int_int(): Unit = {
    val count = new Array[Int](2)
    val sb = new StrBuilder() {
      override def append(str: StrBuilder, startIndex: Int, length: Int): StrBuilder = {
        count(0) += 1
        super.append(str, startIndex, length)
      }
  ...
  @Test def testAppendln_CharArray(): Unit = {
    val count = new Array[Int](2)
    val sb = new StrBuilder() {
      override def append(str: Array[Char]): StrBuilder = {
        count(0) += 1
        super.append(str)
      }
  ...
  @Test def testAppendln_CharArray_int_int(): Unit = {
    val count = new Array[Int](2)
    val sb = new StrBuilder() {
      override def append(str: Array[Char], startIndex: Int, length: Int): StrBuilder = {
        count(0) += 1
        super.append(str, startIndex, length)
      }
  ...
  @Test def testAppendln_Boolean(): Unit = {
    val sb = new StrBuilder
    sb.appendln(true)
  ...
  @Test def testAppendln_PrimitiveNumber(): Unit = {
    val sb = new StrBuilder
    sb.appendln(0)
  ...
  @Test def testAppendPadding(): Unit = {
    val sb = new StrBuilder
    sb.append("foo")
    assertEquals("foo", sb.toString)
    sb.appendPadding(-1, '-')
  ...
  @Test def testAppendFixedWidthPadLeft(): Unit = {
    val sb = new StrBuilder
  ...
  @Test def testAppendFixedWidthPadLeft_int(): Unit = {
    val sb = new StrBuilder
  ...
  @Test def testAppendFixedWidthPadRight(): Unit = {
    val sb = new StrBuilder
  ...
  @Test def testLang299(): Unit = {
    val sb = new StrBuilder(1)
    sb.appendFixedWidthPadRight("foo", 1, '-')
    assertEquals("f", sb.toString)
  }

  @Test def testAppendFixedWidthPadRight_int(): Unit = {
    val sb = new StrBuilder
  ...
  @Test def testAppend_FormattedString(): Unit = {
    var sb: StrBuilder = null
    sb = new StrBuilder
    ...
    sb = new StrBuilder
    sb.append("Hi %s %,d", "Alice", Integer.valueOf(5000))
  ...
  @Test def testAppendAll_Array(): Unit = {
    val sb = new StrBuilder
  ...
  @Test def testAppendAll_Collection(): Unit = {
    val sb = new StrBuilder
  ...
  @Test def testAppendAll_Iterator(): Unit = {
    val sb = new StrBuilder
  ...
  @Test def testAppendWithSeparators_Array(): Unit = {
    val sb = new StrBuilder
  ...
  @Test def testAppendWithSeparators_Collection(): Unit = {
    val sb = new StrBuilder
  ...
  @Test def testAppendWithSeparators_Iterator(): Unit = {
    val sb = new StrBuilder
  ...
  @Test def testAppendWithSeparatorsWithNullText(): Unit = {
    val sb = new StrBuilder
    sb.setNullText("null")
    sb.appendWithSeparators(Array[AnyRef]("foo", null, "baz"), ",")
  ...
  @Test def testAppendSeparator_String(): Unit = {
    val sb = new StrBuilder
  ...
  @Test def testAppendSeparator_String_String(): Unit = {
    val sb = new StrBuilder
  ...
  @Test def testAppendSeparator_char(): Unit = {
    val sb = new StrBuilder
    sb.appendSeparator(',')
    assertEquals("", sb.toString)
    sb.append("foo")
  ...
  @Test def testAppendSeparator_char_char(): Unit = {
    val sb = new StrBuilder
    val startSeparator = ':'
    val standardSeparator = ','
    val foo = "foo"
  ...
  @Test def testAppendSeparator_String_int(): Unit = {
    val sb = new StrBuilder
  ...
  @Test def testAppendSeparator_char_int(): Unit = {
    val sb = new StrBuilder
    sb.appendSeparator(',', 0)
    assertEquals("", sb.toString)
    sb.append("foo")
  ...
  @Test def testInsert(): Unit = {
    ...
    assertThrows[IndexOutOfBoundsException](
      sb.insert(-1, StrBuilderAppendInsertTest.FOO)
    ) //, "insert(-1, Object) expected StringIndexOutOfBoundsException")
    assertThrows[IndexOutOfBoundsException](
      sb.insert(7, StrBuilderAppendInsertTest.FOO)
    ...
    assertEquals("barbaz", sb.toString)
    assertThrows[IndexOutOfBoundsException](
      sb.insert(-1, Array[Char]('f', 'o', 'o'))
    ) //, "insert(-1, char[]) expected StringIndexOutOfBoundsException")
    assertThrows[IndexOutOfBoundsException](
      sb.insert(7, Array[Char]('f', 'o', 'o'))
    ...
    assertEquals("barbaz", sb.toString)
    assertThrows[IndexOutOfBoundsException](
      sb.insert(-1, Array[Char]('a', 'b', 'c', 'f', 'o', 'o', 'd', 'e', 'f'), 3, 3)
    ) //, "insert(-1, char[], 3, 3) expected StringIndexOutOfBoundsException")
    assertThrows[IndexOutOfBoundsException](
      sb.insert(7, Array[Char]('a', 'b', 'c', 'f', 'o', 'o', 'd', 'e', 'f'), 3, 3)
    ...
    assertEquals("barbaz", sb.toString)
    assertThrows[IndexOutOfBoundsException](
      sb.insert(0, Array[Char]('a', 'b', 'c', 'f', 'o', 'o', 'd', 'e', 'f'), -1, 3)
    ) //, "insert(0, char[], -1, 3) expected StringIndexOutOfBoundsException")
    assertThrows[IndexOutOfBoundsException](
      sb.insert(0, Array[Char]('a', 'b', 'c', 'f', 'o', 'o', 'd', 'e', 'f'), 10, 3)
    ) //, "insert(0, char[], 10, 3) expected StringIndexOutOfBoundsException")
    assertThrows[IndexOutOfBoundsException](
      sb.insert(0, Array[Char]('a', 'b', 'c', 'f', 'o', 'o', 'd', 'e', 'f'), 0, -1)
    ) //, "insert(0, char[], 0, -1) expected StringIndexOutOfBoundsException")
    assertThrows[IndexOutOfBoundsException](
      sb.insert(0, Array[Char]('a', 'b', 'c', 'f', 'o', 'o', 'd', 'e', 'f'), 0, 10)
  ...
  @Test def testInsertWithNullText(): Unit = {
    val sb = new StrBuilder
    sb.setNullText("null")
    sb.append("barbaz")
    assertEquals("barbaz", sb.toString)
