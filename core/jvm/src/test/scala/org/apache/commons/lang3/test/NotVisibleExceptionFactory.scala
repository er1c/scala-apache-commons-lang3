...
/**
  ...
  */
object NotVisibleExceptionFactory {
  /**
    ...
    */
  def createException(cause: Throwable): Exception = new NotVisibleException(cause)

  @SerialVersionUID(1L)
  private class NotVisibleException private[NotVisibleExceptionFactory] (val cause: Throwable)
