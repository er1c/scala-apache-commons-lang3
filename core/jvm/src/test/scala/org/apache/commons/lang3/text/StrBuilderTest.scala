...
//  */
//@deprecated object StrBuilderTest {
//
//  private class MockReadable private[text](val src: String) extends Readable {
//    this.src = CharBuffer.wrap(src)
//    final private var src = null
//
//    @throws[IOException]
...
//      if (buffer(pos) == 'A') {
//        pos += 1
//        if (pos < bufferEnd && buffer(pos) >= '0' && buffer(pos) <= '9') return 2
//      }
//      0
//    }
//  }
//}
//
//@deprecated class StrBuilderTest extends JUnitSuite {
//
...
//  @Test
//  @throws[Exception]
//  def testReadFromReaderAppendsToEnd() = {
...
//  @Test
//  @throws[Exception]
//  def testReadFromCharBufferAppendsToEnd() = {
//    val sb = new StrBuilder("Test")
...
//  @Test
//  @throws[Exception]
//  def testReadFromReadableAppendsToEnd() = {
//    val sb = new StrBuilder("Test")
//    sb.readFrom(new StrBuilderTest.MockReadable(" 123"))
//    assertEquals("Test 123", sb.toString)
//  }
//
//  @Test def testGetSetNewLineText() = {
//    val sb = new StrBuilder
...
//  }
//
//  @Test def testCapacityAndLength() = {
//    val sb = new StrBuilder
...
//    assertEquals(33, sb.size)
//    assertFalse(sb.isEmpty)
//    assertThrows(classOf[IndexOutOfBoundsException], () => sb.setLength(-1), "setLength(-1) expected StringIndexOutOfBoundsException")
//    sb.setLength(33)
//    assertEquals(33, sb.capacity)
//    assertEquals(33, sb.length)
//    assertEquals(33, sb.size)
...
//  @Test def testCharAt() = {
//    val sb = new StrBuilder
//    assertThrows(classOf[IndexOutOfBoundsException], () => sb.charAt(0), "charAt(0) expected IndexOutOfBoundsException")
//    assertThrows(classOf[IndexOutOfBoundsException], () => sb.charAt(-1), "charAt(-1) expected IndexOutOfBoundsException")
//    sb.append("foo")
//    assertEquals('f', sb.charAt(0))
//    assertEquals('o', sb.charAt(1))
//    assertEquals('o', sb.charAt(2))
//    assertThrows(classOf[IndexOutOfBoundsException], () => sb.charAt(-1), "charAt(-1) expected IndexOutOfBoundsException")
//    assertThrows(classOf[IndexOutOfBoundsException], () => sb.charAt(3), "charAt(3) expected IndexOutOfBoundsException")
//  }
//
//  @Test def testSetCharAt() = {
//    val sb = new StrBuilder
//    assertThrows(classOf[IndexOutOfBoundsException], () => sb.setCharAt(0, 'f'), "setCharAt(0, ) expected IndexOutOfBoundsException")
//    assertThrows(classOf[IndexOutOfBoundsException], () => sb.setCharAt(-1, 'f'), "setCharAt(-1, ) expected IndexOutOfBoundsException")
//    sb.append("foo")
//    sb.setCharAt(0, 'b')
//    sb.setCharAt(1, 'a')
//    sb.setCharAt(2, 'r')
//    assertThrows(classOf[IndexOutOfBoundsException], () => sb.setCharAt(3, '!'), "setCharAt(3, ) expected IndexOutOfBoundsException")
//    assertEquals("bar", sb.toString)
//  }
//
//  @Test def testDeleteCharAt() = {
//    val sb = new StrBuilder("abc")
//    sb.deleteCharAt(0)
//    assertEquals("bc", sb.toString)
//    assertThrows(classOf[IndexOutOfBoundsException], () => sb.deleteCharAt(1000))
//  }
//
//  @Test def testToCharArray() = {
//    val sb = new StrBuilder
...
//  }
//
//  @Test def testToCharArrayIntInt() = {
//    val sb = new StrBuilder
...
//    assertThrows(classOf[IndexOutOfBoundsException], () => sb.toCharArray(-1, 5), "no string index out of bound on -1")
//    assertThrows(classOf[IndexOutOfBoundsException], () => sb.toCharArray(6, 5), "no string index out of bound on -1")
//  }
//
//  @Test def testGetChars() = {
//    val sb = new StrBuilder
...
//  }
//
//  @Test def testGetCharsIntIntCharArrayInt() = {
//    val sb = new StrBuilder
//    sb.append("junit")
...
//    assertThrows(classOf[IndexOutOfBoundsException], () => sb.getChars(-1, 0, b, 0))
//    assertThrows(classOf[IndexOutOfBoundsException], () => sb.getChars(0, -1, b, 0))
//    assertThrows(classOf[IndexOutOfBoundsException], () => sb.getChars(0, 20, b, 0))
//    assertThrows(classOf[IndexOutOfBoundsException], () => sb.getChars(4, 2, b, 0))
//  }
//
//  @Test def testDeleteIntInt() = {
//    val sb = new StrBuilder("abc")
//    sb.delete(0, 1)
//    assertEquals("bc", sb.toString)
//    sb.delete(1, 2)
...
//    sb.delete(0, 1000)
//    assertEquals("", sb.toString)
//    assertThrows(classOf[IndexOutOfBoundsException], () => sb.delete(1, 2))
//    assertThrows(classOf[IndexOutOfBoundsException], () => sb.delete(-1, 1))
//    assertThrows(classOf[IndexOutOfBoundsException], () => new StrBuilder("anything").delete(2, 1))
//  }
//
//  @Test def testDeleteAll_char() = {
...
//  }
//
//  @Test def testDeleteFirst_String() = {
//    var sb = new StrBuilder("abcbccba")
...
//  }
//
//  @Test def testDeleteAll_StrMatcher() = {
...
//  }
//
//  @Test def testDeleteFirst_StrMatcher() = {
//    var sb = new StrBuilder("A0xA1A2yA3")
...
//  }
//
//  @Test def testReplace_int_int_String() = {
//    val sb = new StrBuilder("abc")
//    sb.replace(0, 1, "d")
...
//    assertThrows(classOf[IndexOutOfBoundsException], () => sb1.replace(2, 1, "anything"))
//    val sb2 = new StrBuilder
//    assertThrows(classOf[IndexOutOfBoundsException], () => sb2.replace(1, 2, "anything"))
//    assertThrows(classOf[IndexOutOfBoundsException], () => sb2.replace(-1, 1, "anything"))
//  }
//
//  @Test def testReplaceAll_char_char() = {
...
//  }
//
//  @Test def testReplaceFirst_char_char() = {
//    val sb = new StrBuilder("abcbccba")
//    sb.replaceFirst('x', 'y')
//    assertEquals("abcbccba", sb.toString)
//    sb.replaceFirst('a', 'd')
...
//  }
//
//  @Test def testReplaceAll_String_String() = {
//    var sb = new StrBuilder("abcbccba")
...
//  }
//
//  @Test def testReplaceFirst_String_String() = {
//    var sb = new StrBuilder("abcbccba")
...
//  }
//
//  @Test def testReplaceAll_StrMatcher_String() = {
//    var sb = new StrBuilder("abcbccba")
...
//  }
//
//  @Test def testReplaceFirst_StrMatcher_String() = {
//    var sb = new StrBuilder("abcbccba")
...
//  }
//
//  @Test def testReplace_StrMatcher_String_int_int_int_VaryMatcher() = {
//    var sb = new StrBuilder("abcbccba")
...
//  }
//
//  @Test def testReplace_StrMatcher_String_int_int_int_VaryReplace() = {
//    var sb = new StrBuilder("abcbccba")
...
//  }
//
//  @Test def testReplace_StrMatcher_String_int_int_int_VaryStartIndex() = {
...
//    assertThrows(classOf[IndexOutOfBoundsException], () => sb1.replace(StrMatcher.stringMatcher("aa"), "-", 11, sb1.length, -1))
//    assertEquals("aaxaaaayaa", sb1.toString)
//    val sb2 = new StrBuilder("aaxaaaayaa")
//    assertThrows(classOf[IndexOutOfBoundsException], () => sb2.replace(StrMatcher.stringMatcher("aa"), "-", -1, sb2.length, -1))
//    assertEquals("aaxaaaayaa", sb2.toString)
//  }
//
//  @Test def testReplace_StrMatcher_String_int_int_int_VaryEndIndex() = {
//    var sb = new StrBuilder("aaxaaaayaa")
...
//    assertEquals("-x--y-", sb.toString)
//    val sb1 = new StrBuilder("aaxaaaayaa")
//    assertThrows(classOf[IndexOutOfBoundsException], () => sb1.replace(StrMatcher.stringMatcher("aa"), "-", 2, 1, -1))
//    assertEquals("aaxaaaayaa", sb1.toString)
//  }
//
//  @Test def testReplace_StrMatcher_String_int_int_int_VaryCount() = {
//    var sb = new StrBuilder("aaxaaaayaa")
//    sb.replace(StrMatcher.stringMatcher("aa"), "-", 0, 10, -1)
//    assertEquals("-x--y-", sb.toString)
//    sb = new StrBuilder("aaxaaaayaa")
...
//  }
//
//  @Test def testSubSequenceIntInt() = {
//    val sb = new StrBuilder("hello goodbye")
//    // Start index is negative
//    assertThrows(classOf[IndexOutOfBoundsException], () => sb.subSequence(-1, 5))
//    // End index is negative
//    assertThrows(classOf[IndexOutOfBoundsException], () => sb.subSequence(2, -1))
//    // End index greater than length()
//    assertThrows(classOf[IndexOutOfBoundsException], () => sb.subSequence(2, sb.length + 1))
//    // Start index greater then end index
//    assertThrows(classOf[IndexOutOfBoundsException], () => sb.subSequence(3, 2))
//    // Normal cases
...
//    assertThrows(classOf[IndexOutOfBoundsException], () => sb.substring(-1))
//    assertThrows(classOf[IndexOutOfBoundsException], () => sb.substring(15))
//  }
//
//  @Test def testSubstringIntInt() = {
//    val sb = new StrBuilder("hello goodbye")
...
//    assertThrows(classOf[IndexOutOfBoundsException], () => sb.substring(-1, 5))
//    assertThrows(classOf[IndexOutOfBoundsException], () => sb.substring(15, 20))
//  }
//
//  @Test def testMidString() = {
...
//  }
//
//  @Test def testContains_StrMatcher() = {
...
//  }
//
//  @Test def testLastIndexOf_char_int() = {
//    var sb = new StrBuilder("abab")
...
//  }
//
//  @Test def testIndexOf_String_int() = {
//    var sb = new StrBuilder("abab")
//    assertEquals(0, sb.indexOf("a", -1))
//    assertEquals(0, sb.indexOf("a", 0))
//    assertEquals(2, sb.indexOf("a", 1))
...
//  }
//
//  @Test def testLastIndexOf_String() = {
//    val sb = new StrBuilder("abab")
//    assertEquals(2, sb.lastIndexOf("a"))
//    assertEquals("abab".lastIndexOf("a"), sb.lastIndexOf("a"))
...
//  }
//
//  @Test def testLastIndexOf_String_int() = {
//    var sb = new StrBuilder("abab")
//    assertEquals(-1, sb.lastIndexOf("a", -1))
//    assertEquals(0, sb.lastIndexOf("a", 0))
//    assertEquals(0, sb.lastIndexOf("a", 1))
...
//  }
//
//  @Test def testIndexOf_StrMatcher() = {
//    val sb = new StrBuilder
...
//  }
//
//  @Test def testIndexOf_StrMatcher_int() = {
//    val sb = new StrBuilder
...
//  }
//
//  @Test def testLastIndexOf_StrMatcher() = {
//    val sb = new StrBuilder
...
//  }
//
//  @Test def testLastIndexOf_StrMatcher_int() = {
//    val sb = new StrBuilder
...
//  }
//
//  @Test def testAsTokenizer() = { // from Javadoc
...
//    assertThrows(classOf[IndexOutOfBoundsException], () => r.read(arr, -1, 0))
//    assertThrows(classOf[IndexOutOfBoundsException], () => r.read(arr, 0, -1))
//    assertThrows(classOf[IndexOutOfBoundsException], () => r.read(arr, 100, 1))
//    assertThrows(classOf[IndexOutOfBoundsException], () => r.read(arr, 0, 100))
//    assertThrows(classOf[IndexOutOfBoundsException], () => r.read(arr, Integer.MAX_VALUE, Integer.MAX_VALUE))
...
//  }
//
//  @Test def test_LANG_1131_EqualsWithNullStrBuilder() = {
//    val sb = new StrBuilder
//    val other = null
...
//  }
//
//  @Test def testLang294() = {
//    val sb = new StrBuilder("\n%BLAH%\nDo more stuff\neven more stuff\n%BLAH%\n")
//    sb.deleteAll("\n%BLAH%")
//    assertEquals("\nDo more stuff\neven more stuff\n", sb.toString)
//  }
//
//  @Test def testIndexOfLang294() = {
//    val sb = new StrBuilder("onetwothree")
//    sb.deleteFirst("three")
//    assertEquals(-1, sb.indexOf("three"))
//  }
//
//  @Test def testLang295() = {
//    val sb = new StrBuilder("onetwothree")
//    sb.deleteFirst("three")
...
//  @Test
//  @throws[Exception]
//  def testAppendToStringBuilder() = {
//    val sb = new StrBuilder("1234567890")
//    val builder = new StringBuilder("Test ")
//    sb.appendTo(builder)
...
//  @Test
//  @throws[Exception]
//  def testAppendToStringBuffer() = {
//    val sb = new StrBuilder("1234567890")
//    val buffer = new StringBuffer("Test ")
//    sb.appendTo(buffer)
