...
//    val a = Array[Double](1.2, Double.NaN, 3.7, 27.0, 42.0, Double.NaN)
...
//  }
//
//  @Test def testEnforceExceptions() = {
//    assertThrows(classOf[NullPointerException], () => IEEE754rUtils.min(null.asInstanceOf[Array[Float]]), "IllegalArgumentException expected for null input")
//    assertThrows(classOf[IllegalArgumentException], IEEE754rUtils.min, "IllegalArgumentException expected for empty input")
//    assertThrows(classOf[NullPointerException], () => IEEE754rUtils.max(null.asInstanceOf[Array[Float]]), "IllegalArgumentException expected for null input")
//    assertThrows(classOf[IllegalArgumentException], IEEE754rUtils.max, "IllegalArgumentException expected for empty input")
//    assertThrows(classOf[NullPointerException], () => IEEE754rUtils.min(null.asInstanceOf[Array[Double]]), "IllegalArgumentException expected for null input")
//    assertThrows(classOf[IllegalArgumentException], IEEE754rUtils.min, "IllegalArgumentException expected for empty input")
//    assertThrows(classOf[NullPointerException], () => IEEE754rUtils.max(null.asInstanceOf[Array[Double]]), "IllegalArgumentException expected for null input")
//    assertThrows(classOf[IllegalArgumentException], IEEE754rUtils.max, "IllegalArgumentException expected for empty input")
//  }
//
