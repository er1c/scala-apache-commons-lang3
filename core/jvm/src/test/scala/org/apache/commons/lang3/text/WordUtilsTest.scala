...
//  }
  ...
  @Test def testWrap_StringInt(): Unit = {
    ...
    var expected =
      "Here is one line of" + systemNewLine + "text that is going" + systemNewLine + "to be wrapped after" + systemNewLine + "20 columns."
    assertEquals(expected, WordUtils.wrap(input, 20))
    // long word at end
    input = "Click here to jump to the commons website - https://commons.apache.org"
    expected =
      "Click here to jump" + systemNewLine + "to the commons" + systemNewLine + "website -" + systemNewLine + "https://commons.apache.org"
    assertEquals(expected, WordUtils.wrap(input, 20))
    // long word in middle
    input = "Click here, https://commons.apache.org, to jump to the commons website"
    expected =
      "Click here," + systemNewLine + "https://commons.apache.org," + systemNewLine + "to jump to the" + systemNewLine + "commons website"
    assertEquals(expected, WordUtils.wrap(input, 20))
  ...
  @Test def testWrap_StringIntStringBoolean(): Unit = {
    assertNull(WordUtils.wrap(null, 20, "\n", false))
    assertNull(WordUtils.wrap(null, 20, "\n", true))
  ...
  @Test def testWrap_StringIntStringBooleanString(): Unit = { //no changes test
  ...
  @Test def testCapitalize_String(): Unit = {
  ...
  @Test def testCapitalizeWithDelimiters_String(): Unit = {
    assertNull(WordUtils.capitalize(null, null.asInstanceOf[Array[Char]]))
    assertEquals("", WordUtils.capitalize(""))
    assertEquals("  ", WordUtils.capitalize("  "))
    ...
    assertEquals("I Am.fine", WordUtils.capitalize("i am.fine", null.asInstanceOf[Array[Char]]))
  }

  @Test def testCapitalizeFully_String(): Unit = {
  ...
  @Test def testCapitalizeFullyWithDelimiters_String(): Unit = {
    assertNull(WordUtils.capitalizeFully(null, null.asInstanceOf[Array[Char]]))
    assertEquals("", WordUtils.capitalizeFully(""))
    assertEquals("  ", WordUtils.capitalizeFully("  "))
    var chars = Array[Char]('-', '+', ' ', '@')
    ...
    assertEquals("I Am.fine", WordUtils.capitalizeFully("i am.fine", null.asInstanceOf[Array[Char]]))
  }

  @Test def testContainsAllWords_StringString(): Unit = {
  ...
  @Test def testUncapitalize_String(): Unit = {
  ...
  @Test def testUncapitalizeWithDelimiters_String(): Unit = {
    assertNull(WordUtils.uncapitalize(null, null.asInstanceOf[Array[Char]]))
    assertEquals("", WordUtils.uncapitalize(""))
    assertEquals("  ", WordUtils.uncapitalize("  "))
    var chars = Array[Char]('-', '+', ' ', '@')
    ...
    assertEquals("i aM.FINE", WordUtils.uncapitalize("I AM.FINE", null.asInstanceOf[Array[Char]]))
  }

  @Test def testInitials_String(): Unit = {
  ...
  // -----------------------------------------------------------------------
  @Test def testInitials_String_charArray(): Unit = {
  ...
  @Test def testLANG1292(): Unit = { // Prior to fix, this was throwing StringIndexOutOfBoundsException
    WordUtils.wrap(
      "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa " + "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa " + "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa",
      70)
    ()
  }

  @Test def testLANG1397(): Unit = {
    WordUtils.wrap(
      "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa " + "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa " + "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa",
      Integer.MAX_VALUE)
    ()
