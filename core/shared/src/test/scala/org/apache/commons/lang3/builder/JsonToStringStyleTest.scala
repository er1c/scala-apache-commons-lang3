...
//import java.util
//import java.util.{ArrayList, Arrays, Collections, Date, HashMap, LinkedHashMap, List, Map}
...
//      * Test String field.
//      */
//    private[builder] val pid = null
//    /**
//      * Test nested object field.
//      */
//    private[builder] val person = null
//  }
//
//  final private[builder] class Hobby {}
//
//  final private[builder] class EmptyEnum {}
//
//  private[builder] class Student {
//    private[builder] var hobbies = null
//
...
//    private[builder] var teacher = null
//    private[builder] var students = null
//
...
//    assertThrows(classOf[UnsupportedOperationException], () => new ToStringBuilder(base).append('A').toString)
...
//    assertThrows(classOf[UnsupportedOperationException], () => new ToStringBuilder(base).append(now).toString)
...
//    assertThrows(classOf[UnsupportedOperationException], () => new ToStringBuilder(base).append(i3).toString)
...
//    assertThrows(classOf[UnsupportedOperationException], () => new ToStringBuilder(base).append(3L).toString)
...
//    assertThrows(classOf[UnsupportedOperationException], () => toStringBuilder.append(array).toString)
//    assertEquals("{\"objectArray\":[null,5,[3,6]]}", toStringBuilder.append("objectArray", array).toString)
//    assertThrows(classOf[UnsupportedOperationException], () => toStringBuilder.append(array.asInstanceOf[Any]).toString)
//    assertThrows(
//      classOf[UnsupportedOperationException],
//      () => toStringBuilder.append(null.asInstanceOf[Array[AnyRef]]).toString)
//    assertThrows(classOf[UnsupportedOperationException], () => toStringBuilder.append(array.asInstanceOf[Any]).toString)
//  }
//
...
//    assertThrows(
//      classOf[UnsupportedOperationException],
//      () => toStringBuilder.append(null.asInstanceOf[Array[Long]]).toString)
//    assertThrows(classOf[UnsupportedOperationException], () => toStringBuilder.append(array.asInstanceOf[Any]).toString)
//  }
//
...
//    assertThrows(
//      classOf[UnsupportedOperationException],
//      () => toStringBuilder.append(null.asInstanceOf[Array[Array[Long]]]).toString)
//    assertThrows(classOf[UnsupportedOperationException], () => toStringBuilder.append(array.asInstanceOf[Any]).toString)
//  }
//
