...
object ArrayUtilsRemoveMultipleTest {
...
/**
  ...
  */
class ArrayUtilsRemoveMultipleTest extends JUnitSuite with AssertionsForJUnit {
  import ArrayUtilsRemoveMultipleTest._
  ...
  @Test def testRemoveAllDoubleArray(): Unit = {
    ...
    assertArrayEquals(Array[Double](3), array, DoubleDelta)
    assertEquals(JavaDouble.TYPE, array.getClass.getComponentType)
    ...
    assertArrayEquals(Array[Double](1, 3, 5), array, DoubleDelta)
    assertEquals(JavaDouble.TYPE, array.getClass.getComponentType)
    array = ArrayUtils.removeAll(Array[Double](1, 2, 3, 4, 5), 0, 2, 4)
    assertArrayEquals(Array[Double](2, 4), array, DoubleDelta)
    assertEquals(JavaDouble.TYPE, array.getClass.getComponentType)
    array = ArrayUtils.removeAll(Array[Double](1, 2, 3, 4, 5, 6, 7), 1, 3, 5)
    assertArrayEquals(Array[Double](1, 3, 5, 7), array, DoubleDelta)
    assertEquals(JavaDouble.TYPE, array.getClass.getComponentType)
    array = ArrayUtils.removeAll(Array[Double](1, 2, 3, 4, 5, 6, 7), 0, 2, 4, 6)
    assertArrayEquals(Array[Double](2, 4, 6), array, DoubleDelta)
    assertEquals(JavaDouble.TYPE, array.getClass.getComponentType)
  }
  ...
  @Test def testRemoveAllDoubleArrayRemoveNone(): Unit = {
    ...
    val array2 = ArrayUtils.removeAll(array1)
    assertNotSame(array1, array2)
    assertArrayEquals(array1, array2, DoubleDelta)
  ...
  @Test def testRemoveAllFloatArray(): Unit = {
    ...
    assertArrayEquals(Array[Float](3), array, FloatDelta)
    assertEquals(JavaFloat.TYPE, array.getClass.getComponentType)
    ...
    assertArrayEquals(Array[Float](1, 3, 5), array, FloatDelta)
    assertEquals(JavaFloat.TYPE, array.getClass.getComponentType)
    array = ArrayUtils.removeAll(Array[Float](1, 2, 3, 4, 5), 0, 2, 4)
    assertArrayEquals(Array[Float](2, 4), array, FloatDelta)
    assertEquals(JavaFloat.TYPE, array.getClass.getComponentType)
    array = ArrayUtils.removeAll(Array[Float](1, 2, 3, 4, 5, 6, 7), 1, 3, 5)
    assertArrayEquals(Array[Float](1, 3, 5, 7), array, FloatDelta)
    assertEquals(JavaFloat.TYPE, array.getClass.getComponentType)
    array = ArrayUtils.removeAll(Array[Float](1, 2, 3, 4, 5, 6, 7), 0, 2, 4, 6)
    assertArrayEquals(Array[Float](2, 4, 6), array, FloatDelta)
    assertEquals(JavaFloat.TYPE, array.getClass.getComponentType)
  }
  ...
  @Test def testRemoveAllFloatArrayRemoveNone(): Unit = {
    ...
    val array2 = ArrayUtils.removeAll(array1)
    assertNotSame(array1, array2)
    assertArrayEquals(array1, array2, FloatDelta)
