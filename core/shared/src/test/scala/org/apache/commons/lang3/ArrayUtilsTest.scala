...
//  }
  ...
  @Test def testReverseDouble(): Unit = {
    ...
    ArrayUtils.reverse(array)
    assertEquals(0.5d, array(0), DoubleDelta)
    assertEquals(0.4d, array(1), DoubleDelta)
    assertEquals(0.3d, array(2), DoubleDelta)
    array = null
    ArrayUtils.reverse(array)
    assertNull(array)
  }
  ...
  @Test def testReverseDoubleRange(): Unit = {
    ...
    ArrayUtils.reverse(array, 0, 3)
    assertEquals(3d, array(0), DoubleDelta)
    assertEquals(2d, array(1), DoubleDelta)
    assertEquals(1d, array(2), DoubleDelta)
    array = Array[Double](1d, 2d, 3d)
    ArrayUtils.reverse(array, 0, 2)
    assertEquals(2d, array(0), DoubleDelta)
    assertEquals(1d, array(1), DoubleDelta)
    assertEquals(3d, array(2), DoubleDelta)
    array = Array[Double](1d, 2d, 3d)
    ArrayUtils.reverse(array, -1, 3)
    assertEquals(3d, array(0), DoubleDelta)
    assertEquals(2d, array(1), DoubleDelta)
  ...
  @Test def testReverseFloat(): Unit = {
    ...
    ArrayUtils.reverse(array)
    assertEquals(0.5f, array(0), FloatDelta)
    assertEquals(0.4f, array(1), FloatDelta)
    assertEquals(0.3f, array(2), FloatDelta)
    array = null
    ArrayUtils.reverse(array)
    assertNull(array)
  }
  ...
  @Test def testReverseFloatRange(): Unit = {
    ...
    ArrayUtils.reverse(array, 0, 3)
    assertEquals(3f, array(0), FloatDelta)
    assertEquals(2f, array(1), FloatDelta)
    assertEquals(1f, array(2), FloatDelta)
    array = Array[Float](1f, 2f, 3f)
    ArrayUtils.reverse(array, 0, 2)
    assertEquals(2f, array(0), FloatDelta)
    assertEquals(1f, array(1), FloatDelta)
    assertEquals(3f, array(2), FloatDelta)
    array = Array[Float](1f, 2f, 3f)
    ArrayUtils.reverse(array, -1, 3)
    assertEquals(3f, array(0), FloatDelta)
    assertEquals(2f, array(1), FloatDelta)
  ...
  @Test def testShiftAllDouble(): Unit = {
    ...
    ArrayUtils.shift(array, 4)
    assertEquals(1d, array(0), DoubleDelta)
    assertEquals(2d, array(1), DoubleDelta)
    assertEquals(3d, array(2), DoubleDelta)
    assertEquals(4d, array(3), DoubleDelta)
    ArrayUtils.shift(array, -4)
    assertEquals(1d, array(0), DoubleDelta)
    assertEquals(2d, array(1), DoubleDelta)
    assertEquals(3d, array(2), DoubleDelta)
  ...
  @Test def testShiftAllFloat(): Unit = {
    ...
    ArrayUtils.shift(array, 4)
    assertEquals(1f, array(0), FloatDelta)
    assertEquals(2f, array(1), FloatDelta)
    assertEquals(3f, array(2), FloatDelta)
    assertEquals(4f, array(3), FloatDelta)
    ArrayUtils.shift(array, -4)
    assertEquals(1f, array(0), FloatDelta)
    assertEquals(2f, array(1), FloatDelta)
    assertEquals(3f, array(2), FloatDelta)
  ...
  @Test def testShiftDouble(): Unit = {
    val array = Array[Double](1d, 2d, 3d, 4d)
    ArrayUtils.shift(array, 1)
    assertEquals(4d, array(0), DoubleDelta)
    assertEquals(1d, array(1), DoubleDelta)
    assertEquals(2d, array(2), DoubleDelta)
    assertEquals(3d, array(3), DoubleDelta)
    ArrayUtils.shift(array, -1)
    assertEquals(1d, array(0), DoubleDelta)
    assertEquals(2d, array(1), DoubleDelta)
    assertEquals(3d, array(2), DoubleDelta)
    ...
    ArrayUtils.shift(array, -3)
    assertEquals(3d, array(0), DoubleDelta)
    assertEquals(4d, array(1), DoubleDelta)
    assertEquals(1d, array(2), DoubleDelta)
    assertEquals(2d, array(3), DoubleDelta)
  }

  @Test def testShiftFloat(): Unit = {
    val array = Array[Float](1f, 2f, 3f, 4f)
    ArrayUtils.shift(array, 1)
    assertEquals(4f, array(0), FloatDelta)
    assertEquals(1f, array(1), FloatDelta)
    assertEquals(2f, array(2), FloatDelta)
    assertEquals(3f, array(3), FloatDelta)
    ArrayUtils.shift(array, -1)
    assertEquals(1f, array(0), FloatDelta)
    assertEquals(2f, array(1), FloatDelta)
    assertEquals(3f, array(2), FloatDelta)
    ...
    ArrayUtils.shift(array, -3)
    assertEquals(3f, array(0), FloatDelta)
    assertEquals(4f, array(1), FloatDelta)
    assertEquals(1f, array(2), FloatDelta)
    assertEquals(2f, array(3), FloatDelta)
  }
  ...
  @Test def testShiftRangeDouble(): Unit = {
    ...
    ArrayUtils.shift(array, 1, 3, 1)
    assertEquals(1d, array(0), DoubleDelta)
    assertEquals(3d, array(1), DoubleDelta)
    assertEquals(2d, array(2), DoubleDelta)
    assertEquals(4d, array(3), DoubleDelta)
    assertEquals(5d, array(4), DoubleDelta)
    ArrayUtils.shift(array, 1, 4, 2)
    assertEquals(1d, array(0), DoubleDelta)
    assertEquals(2d, array(1), DoubleDelta)
    assertEquals(4d, array(2), DoubleDelta)
    assertEquals(3d, array(3), DoubleDelta)
    assertEquals(5d, array(4), DoubleDelta)
  }
  ...
  @Test def testShiftRangeFloat(): Unit = {
    ...
    ArrayUtils.shift(array, 1, 3, 1)
    assertEquals(1f, array(0), FloatDelta)
    assertEquals(3f, array(1), FloatDelta)
    assertEquals(2f, array(2), FloatDelta)
    assertEquals(4f, array(3), FloatDelta)
    assertEquals(5f, array(4), FloatDelta)
    ArrayUtils.shift(array, 1, 4, 2)
    assertEquals(1f, array(0), FloatDelta)
    assertEquals(2f, array(1), FloatDelta)
    assertEquals(4f, array(2), FloatDelta)
    assertEquals(3f, array(3), FloatDelta)
    assertEquals(5f, array(4), FloatDelta)
  }
  ...
  @Test def testSwapFloat(): Unit = {
    ...
    ArrayUtils.swap(array, 0, 2)
    assertEquals(3, array(0), FloatDelta)
    assertEquals(2, array(1), FloatDelta)
    assertEquals(1, array(2), FloatDelta)
  }
