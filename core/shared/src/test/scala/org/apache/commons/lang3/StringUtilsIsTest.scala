...
class StringUtilsIsTest extends JUnitSuite {
  ...
  @Test def testIsAlphanumeric(): Unit = {
  ...
  @Test def testIsAlphanumericSpace(): Unit = {
  ...
  @Test def testIsAlphaspace(): Unit = {
  ...
  @Test def testIsAsciiPrintable_String(): Unit = {
  ...
  @Test def testIsNumericSpace(): Unit = {
  ...
  @Test def testIsWhitespace(): Unit = {
