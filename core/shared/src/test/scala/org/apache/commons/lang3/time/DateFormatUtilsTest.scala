...
//  */
//@SuppressWarnings(Array("deprecation")) // tests lots of deprecated items class
//class DateFormatUtilsTest {
//  @Test def testConstructor (): Unit = {
//    assertNotNull (new Nothing)
//    val cons: Array[Constructor[_]] = classOf[Nothing].getDeclaredConstructors
...
//  }
//  @Test def testFormat (): Unit = {
//    val c: Calendar = Calendar.getInstance (FastTimeZone.getGmtTimeZone)
...
//  }
//  @Test def testFormatCalendar (): Unit = {
//    val c: Calendar = Calendar.getInstance (FastTimeZone.getGmtTimeZone)
//    c.set (2005, Calendar.JANUARY, 1, 12, 0, 0)
//    c.setTimeZone (TimeZone.getDefault)
//    val buffer: StringBuilder = new StringBuilder
...
//  }
//  private def assertFormats (expectedValue: String, pattern: String, timeZone: TimeZone, cal: Calendar): Unit = {
...
//  }
//  private def createFebruaryTestDate (timeZone: TimeZone): Calendar = {
//    val cal: Calendar = Calendar.getInstance (timeZone)
//    cal.set (2002, Calendar.FEBRUARY, 23, 9, 11, 12)
//    return cal
//  }
//  private def createJuneTestDate (timeZone: TimeZone): Calendar = {
//    val cal: Calendar = Calendar.getInstance (timeZone)
//    cal.set (2003, Calendar.JUNE, 8, 10, 11, 12)
//    return cal
//  }
//  private def testGmtMinus3 (expectedValue: String, pattern: String): Unit = {
//    val timeZone: TimeZone = TimeZone.getTimeZone ("GMT-3")
//    assertFormats (expectedValue, pattern, timeZone, createFebruaryTestDate (timeZone) )
//  }
//  private def testUTC (expectedValue: String, pattern: String): Unit = {
//    val timeZone: TimeZone = FastTimeZone.getGmtTimeZone
//    assertFormats (expectedValue, pattern, timeZone, createFebruaryTestDate (timeZone) )
//  }
//  @Test def testDateTimeISO (): Unit = {
...
//  }
//  @DefaultLocale (language = "en")@Test def testSMTP (): Unit = {
//    var timeZone: TimeZone = TimeZone.getTimeZone ("GMT-3")
//    var june: Calendar = createJuneTestDate (timeZone)
...
//  def testLANG1000 (): Unit = {
//    val date: String = "2013-11-18T12:48:05Z"
//    DateFormatUtils.ISO_DATETIME_TIME_ZONE_FORMAT.parse (date)
//  }
//  @DefaultTimeZone ("UTC")@Test@throws[ParseException]
//  def testLang530 (): Unit = {
//    val d: Date = new Date
//    val isoDateStr: String = DateFormatUtils.ISO_DATETIME_TIME_ZONE_FORMAT.format (d)
//    val d2: Date = DateUtils.parseDate (isoDateStr, DateFormatUtils.ISO_DATETIME_TIME_ZONE_FORMAT.getPattern)
...
//    */
//  @Test def testLang916 (): Unit = {
//    val cal: Calendar = Calendar.getInstance (TimeZone.getTimeZone ("Europe/Paris") )
//    cal.clear ()
//    cal.set (2009, 9, 16, 8, 42, 16)
//    // Long.
//    val value: String = DateFormatUtils.format (cal.getTimeInMillis, DateFormatUtils.ISO_DATETIME_TIME_ZONE_FORMAT.getPattern, TimeZone.getTimeZone ("Europe/Paris") )
//    assertEquals ("2009-10-16T08:42:16+02:00", value, "long")
//
//    val value: String = DateFormatUtils.format (cal.getTimeInMillis, DateFormatUtils.ISO_DATETIME_TIME_ZONE_FORMAT.getPattern, TimeZone.getTimeZone ("Asia/Kolkata") )
//    assertEquals ("2009-10-16T12:12:16+05:30", value, "long")
//
//    val value: String = DateFormatUtils.format (cal.getTimeInMillis, DateFormatUtils.ISO_DATETIME_TIME_ZONE_FORMAT.getPattern, TimeZone.getTimeZone ("Europe/London") )
//    assertEquals ("2009-10-16T07:42:16+01:00", value, "long")
//
//    // Calendar.
//    val value: String = DateFormatUtils.format (cal, DateFormatUtils.ISO_DATETIME_TIME_ZONE_FORMAT.getPattern, TimeZone.getTimeZone ("Europe/Paris") )
//    assertEquals ("2009-10-16T08:42:16+02:00", value, "calendar")
//
//    val value: String = DateFormatUtils.format (cal, DateFormatUtils.ISO_DATETIME_TIME_ZONE_FORMAT.getPattern, TimeZone.getTimeZone ("Asia/Kolkata") )
//    assertEquals ("2009-10-16T12:12:16+05:30", value, "calendar")
//
//    val value: String = DateFormatUtils.format (cal, DateFormatUtils.ISO_DATETIME_TIME_ZONE_FORMAT.getPattern, TimeZone.getTimeZone ("Europe/London") )
