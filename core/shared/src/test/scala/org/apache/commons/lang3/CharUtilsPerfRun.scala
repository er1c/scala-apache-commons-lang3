...
//  *
//  */
//object CharUtilsPerfRun {
//  private val VERSION = "$Id$"
//  private val WARM_UP = 100
//  private val COUNT = 5000
//  private var CHAR_SAMPLES = null
//
//  def main(args: Array[String]) = new CharUtilsPerfRun().run()
//
//  try CHAR_SAMPLES = new Array[Char](Character.MAX_VALUE)
//  var i = Character.MIN_VALUE
//  while ( {
...
//}
//
//class CharUtilsPerfRun {
//  private def printSysInfo() = {
//    System.out.println(CharUtilsPerfRun.VERSION)
...
//    run_CharUtils_isAsciiNumeric(CharUtilsPerfRun.WARM_UP)
//    start = System.currentTimeMillis
//    run_CharUtils_isAsciiNumeric(CharUtilsPerfRun.COUNT)
//    this.printlnTotal("run_CharUtils_isAsciiNumeric", start)
//    run_inlined_CharUtils_isAsciiNumeric(CharUtilsPerfRun.WARM_UP)
//    start = System.currentTimeMillis
//    run_inlined_CharUtils_isAsciiNumeric(CharUtilsPerfRun.COUNT)
//    this.printlnTotal("run_inlined_CharUtils_isAsciiNumeric", start)
//    run_CharSet(CharUtilsPerfRun.WARM_UP)
//    start = System.currentTimeMillis
//    run_CharSet(CharUtilsPerfRun.COUNT)
//    this.printlnTotal("run_CharSet", start)
//  }
//
//  private def run_CharSet(loopCount: Int) = {
//    var t = 0
//    for (i <- 0 until loopCount) {
//      for (ch <- CharUtilsPerfRun.CHAR_SAMPLES) {
//        val b = CharSet.ASCII_NUMERIC.contains(ch)
//        t +=
//        if (b) 1
//        else 0
//      }
...
//  }
//
//  private def run_CharUtils_isAsciiNumeric(loopCount: Int) = {
//    var t = 0
//    for (i <- 0 until loopCount) {
//      for (ch <- CharUtilsPerfRun.CHAR_SAMPLES) {
//        val b = CharUtils.isAsciiNumeric(ch)
//        t +=
//        if (b) 1
//        else 0
//      }
...
//  }
//
//  private def run_inlined_CharUtils_isAsciiNumeric(loopCount: Int) = {
//    var t = 0
//    for (i <- 0 until loopCount) {
//      for (ch <- CharUtilsPerfRun.CHAR_SAMPLES) {
//        val b = ch >= '0' && ch <= '9'
...
//  }
//
//  private def printlnTotal(prefix: String, start: Long) = {
