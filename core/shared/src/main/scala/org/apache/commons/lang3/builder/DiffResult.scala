...
//    * </p>
//    */
//  val OBJECTS_SAME_STRING = ""
//  private val DIFFERS_STRING = "differs from"
//}
//
//class DiffResult[T] private[builder](val lhs: T, val rhs: T, val diffs: (List[Diff[_$1]]) forSome {type _$1}, val style: ToStringStyle)
//
///**
//  * <p>
...
//  type _$1
//} {
//  Validate.notNull (left, "Left hand object cannot be null")
//  Validate.notNull (right, "Right hand object cannot be null")
...
//  this.style = style
//}
//  final private var style: ToStringStyle = null
//
//  /**
...
//    */
//  def getDiffs: (util.List[Diff[_$1]] ) forSome {
//  type _$1
//} = {
...
//    * @return the style
//    */
//  def getToStringStyle: ToStringStyle = {
//  return style
//}
//
//  /**
...
//    * @return a {@code String} description of the differences.
//    */
//  def toString (style: ToStringStyle): String = {
//  if (diffs.isEmpty) {
//  return DiffResult.OBJECTS_SAME_STRING
//}
//  val lhsBuilder: ToStringBuilder = new ToStringBuilder (lhs, style)
//  val rhsBuilder: ToStringBuilder = new ToStringBuilder (rhs, style)
//
...
//    * @return the iterator
//    */
//  override def iterator: (util.Iterator[Diff[_$1]] ) forSome {
//  type _$1
//} = {
