...
//    value -= wholeNumber
//    var numer0 = 0 // the pre-previous
//    var denom0 = 1
//    var numer1 = 1 // the previous
//    var denom1 = 0
//    var numer2 = 0 // the current, setup in calculation
//    var denom2 = 0
//    var a1 = value.toInt
//    var a2 = 0
//    var x1 = 1
...
//    // parse double format
//    var pos = str.indexOf('.')
//    if (pos >= 0) return getFraction(str.toDouble)
//    // parse X Y/Z format
//    pos = str.indexOf(' ')
//    if (pos > 0) {
//      val whole = str.substring(0, pos).toInt
//      str = str.substring(pos + 1)
//      pos = str.indexOf('/')
//      if (pos < 0) throw new NumberFormatException("The fraction could not be parsed as the format X Y/Z")
//      val numer = str.substring(0, pos).toInt
//      val denom = str.substring(pos + 1).toInt
//      return getFraction(whole, numer, denom)
//    }
//    // parse Y/Z format
//    pos = str.indexOf('/')
//    if (pos < 0) { // simple whole number
//      return getFraction(str.toInt, 1)
//    }
//    val numer = str.substring(0, pos).toInt
//    val denom = str.substring(pos + 1).toInt
...
//    */
//  private def greatestCommonDivisor(u: Int, v: Int): Int = { // From Commons Math:
//    if (u == 0 || v == 0) {
//      if (u == Integer.MIN_VALUE || v == Integer.MIN_VALUE) throw new ArithmeticException("overflow: gcd is 2^31")
...
//        /* assert x>=0 && y>=0; */ val m = x.toLong * y.toLong
...
//        */
//      private var toProperString = null
//
//      /**
...
//        */
//      def reduce: Fraction = {
//        if (numerator == 0) return if (this == Fraction.ZERO) this
//        else Fraction.ZERO
...
//        *                             {@code Integer.MAX_VALUE}
//        */
//      def pow(power: Int): Fraction = if (power == 1) this
...
//        if (numerator == 0) return if (isAdd) fraction
...
//          return new Fraction(if (isAdd) Fraction.addAndCheck(uvp, upv)
//          else Fraction.subAndCheck(uvp, upv), Fraction.mulPosAndCheck(denominator, fraction.denominator))
//        }
...
//        Fraction.getReducedFraction(Fraction.mulAndCheck(numerator / d1, fraction.numerator / d2), Fraction.mulPosAndCheck(denominator / d2, fraction.denominator / d1))
//      }
//
//      /**
...
//        if (hashCode == 0) { // hash code update should be atomic.
...
//        if (toProperString == null) if (numerator == 0) toProperString = "0"
//        else if (numerator == denominator) toProperString = "1"
//        else if (numerator == -1 * denominator) toProperString = "-1"
...
//          else toProperString = getProperWhole + " " + properNumerator + "/" + getDenominator
//        }
//        else toProperString = getNumerator + "/" + getDenominator
//        toProperString
//      }
//    }