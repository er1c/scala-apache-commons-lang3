...
object ObjectUtils {
  ...
  /**
    ...
    * @return the clone if the object implements {@link java.lang.Cloneable} otherwise {@code null}
  ...
  /**
    ...
    *
    * <p>This method is similar to {@link #clone[T](obj:T)*}, but will return the provided
    ...
    * @tparam T the type of the object
    * @param obj the object to clone, null returns null
    * @return the clone if the object implements {@link java.lang.Cloneable} otherwise the object itself
    * @throws org.apache.commons.lang3.exception.CloneFailedException if the object is cloneable and the clone operation fails
    * @since 3.0
    */
  ...
  /**
    * <p>
    * Returns the given {@code object} is it is non-null, otherwise returns the Supplier's {@link java.util.function.Supplier#get}
    * value.
    * </p>
    *
    * <p>
  ...
  /**
    ...
    * <li>{@code java.lang.Array}: Considered empty if its length is zero.</li>
    * <li>{@link java.util.Collection}: Considered empty if it has zero elements.</li>
    * <li>{@link java.util.Map}: Considered empty if it has zero key-value mappings.</li>
    * </ul>
    *
    * <pre>
  ...
  def isEmpty(`object`: Any): Boolean = {
    ...
    if (`object`.getClass.isArray) return ReflectArray.getLength(`object`) == 0
