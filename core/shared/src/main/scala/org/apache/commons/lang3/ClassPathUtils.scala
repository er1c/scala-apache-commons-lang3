...
object ClassPathUtils {
  /**
    ...
    */
  def toFullyQualifiedName(context: Class[_], resourceName: String): String = {
    ...
    toFullyQualifiedName(context.getPackage, resourceName)
  }
  ...
  /**
    ...
    * @throws java.lang.NullPointerException if either {@code context} or {@code resourceName} is null.
    */
  def toFullyQualifiedName(context: Package, resourceName: String): String = {
    Validate.notNull(context, "Parameter '%s' must not be null!", "context")
    Validate.notNull(resourceName, "Parameter '%s' must not be null!", "resourceName")
  ...
  /**
    ...
    * @throws java.lang.NullPointerException if either {@code context} or {@code resourceName} is null.
    */
  def toFullyQualifiedPath(context: Class[_], resourceName: String): String = {
    Validate.notNull(context, "Parameter '%s' must not be null!", "context")
    Validate.notNull(resourceName, "Parameter '%s' must not be null!", "resourceName")
    toFullyQualifiedPath(context.getPackage, resourceName)
  }
  ...
  /**
    ...
    * @throws java.lang.NullPointerException if either {@code context} or {@code resourceName} is null.
    */
  def toFullyQualifiedPath(context: Package, resourceName: String): String = {
    Validate.notNull(context, "Parameter '%s' must not be null!", "context")
    Validate.notNull(resourceName, "Parameter '%s' must not be null!", "resourceName")
    context.getName.replace('.', '/') + "/" + resourceName
  }
}
