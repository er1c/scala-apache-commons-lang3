...
abstract class Pair[L, R] extends util.Map.Entry[L, R] with Comparable[Pair[L, R]] with Serializable {
  ...
  /**
    ...
    *
    * <p>This method implements the {@code java.util.Map.Entry} interface returning the
  ...
  /**
    ...
    * The hash code follows the definition in {@code java.util.Map.Entry}.</p>
    *
  ...
  /**
    ...
    * The default format used by {@code toString()} is {@code (%1,%2)}.</p>
    *
